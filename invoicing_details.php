        ...
        <?php } ?>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-2 bg-primary">
                        <h6 class="m-0 font-weight-bold text-light">Invoice Summary</h6> 
                    </div>
                    <div class="card-body">
                                ...
                                <div class="col-12">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-sm" width="100%" cellspacing="0">
                                            <?php
                                            $details_query = mysqli_query($conn, "SELECT *,sum(finalqty) FROM tbl_trips_raw WHERE sino = '$sino'");
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="background: #f2f2f2;"><b>TM #:</td>
                                                    <td><?php echo $fetch_details['tmno']; ?></td>

                                                </tr>
                                                <tr>
                                                    <td style="background: #f2f2f2;"><b>SO #:</td>
                                                    <td><?php echo $fetch_details['sono']; ?></td>
                                                ...
                                                <tr>
                                                    <td style="background: #f2f2f2;"><b>Picklist #:</td>
                                                    <td><?php echo $fetch_details['picklistno']; ?></td>
                                                    <td style="background: #f2f2f2;"><b>Status:</td>
                                                    <td></td>
                                                </tr>
                                                <tr>
                                                    <td style="background: #f2f2f2;"><b>Branch:</td>
                                                    <td><?php echo $fetch_details['brname']; ?></td>
                                                    <td style="background: #f2f2f2;"><b>Cluster:</td>
                                                    <td><?php echo $fetch_details['cluster']; ?></td>
                                                </tr>
                                                <tr>
                                                    <td style="background: #f2f2f2;"><b>Attachments:</td>
                                                    <td colspan="3"></td>
                                                </tr>
                                            </tbody>
                                        </table>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-sm text-center" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    <?php
                                    $result = mysqli_query($conn, "SELECT * FROM tbl_trips_raw WHERE sino = '$sino'");
