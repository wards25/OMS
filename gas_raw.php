...
?>
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex align-items-center justify-content-between mb-3">
            <h4 class="mb-0 text-gray-800">Gascon</h4>
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-wrap justify-content-between align-items-start" style="gap: 10px;">
                            <div class="flex-grow-1 min-w-0 me-md-3">
                                <div class="table-responsive">
                                    ...
                                    $validated_count = 0;
                                    $enrolled_count = 0;
                                    $data_query = mysqli_query($conn,"SELECT validated FROM tbl_customer WHERE tag = 'GASCON'");
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-sm text-center" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    <?php
                                        $result = mysqli_query($conn,"SELECT * FROM tbl_customer WHERE tag='GASCON'");
                                        while($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            ?>
                                            <td><center><a class="d-sm-inline-block btn btn-sm btn-warning" name="edit" type="button" <?php if (in_array(166, $permission)) { echo 'href="cif_update.php?link=gas_raw.php&tag='.$row['tag'].'&ref_no='.$row['serial_no'].'"'; } else {  echo 'data-toggle="modal" data-target="#alertModal"'; } ?>><i class="fa fa-edit fa-sm"></i></a></center></td>
                                            <td><center><a class="d-sm-inline-block btn btn-sm btn-info" name="view" type="button" <?php if (in_array(167, $permission)) { echo 'href="cif_view.php?link=gas_raw.php&tag='.$row['tag'].'&ref_no='.$row['serial_no'].'"'; } else {  echo 'data-toggle="modal" data-target="#alertModal"'; } ?>><i class="fa fa-eye fa-sm"></i></a></center></td>
                ...
                <div class="modal fade" id="exportModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog modal-md" role="document">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="cif_export.php?form=GAS">
