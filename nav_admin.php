...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #21c275;">
            ...
            <li class="nav-item">
                <a class="nav-link" href="checklist_admin.php">
            ...
            if(in_array(59, $permission)){
                echo '
                <li class="nav-item">
                    <a class="nav-link" href="facility_raw.php">
                    <i class="fa-solid fa-building"></i>
                    <span>General Facilities</span></a>
                </li>';
            }else{
            }
            ...
            if(in_array(67, $permission)){
                echo '
                <li class="nav-item">
                    <a class="nav-link" href="fireext_raw.php">
                    <i class="fa-solid fa-fire-extinguisher"></i>
                    <span>Fire Extinguisher</span></a>
                </li>';
            }else{
            }
            ...
            if(in_array(75, $permission)){
                echo '
                <li class="nav-item">
                    <a class="nav-link" href="mousetrap_raw.php">
                    <i class="fa-solid fa-bars"></i>
                    <span>Mouse Trap</span></a>
                </li>';
            }else{
            }
            ...
            if(in_array(27, $permission)){
                echo '
                <li class="nav-item">
                    <a class="nav-link" href="warehouselock_raw.php">
                    <i class="fa-solid fa-shop-lock"></i>
                    <span>Warehouse Lock</span></a>
                </li>';
            }else{
            }
