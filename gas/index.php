                                ...
                                <div class="col-12 col-md-6 mb-0">
                                    <div class="row align-items-center">
                                        <div class="col-12 col-sm-6 col-md-6">
                                            <h6 class="mb-0"><small class="text-danger">*</small> Are you a WHT Agent (EWT)?:</h6>
                                        </div>
                                        <div class="col-12 col-sm-6 col-md-6">
                                            <div class="col-12 d-flex flex-column flex-md-row gap-3">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="ewt" value="1" id="radioYes" required checked>
                                                    <label class="form-check-label" for="radioYes">YES</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="ewt" value="0" id="radioNo" required>
                                    ...
                                    <div class="col-12 col-md-6 mb-0">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-12 col-sm-8 col-md-8">
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-4">
                                                        <button type="button" class="btn btn-sm btn-outline-primary btn-block" onclick="openCamera('birInput')">
                                                            <i class="fa fa-sm fa-solid fa-camera"></i> Camera
                                                        </button>
                                                    </div>
                                                    <div class="col-4">
                                                        <button type="button" class="btn btn-sm btn-outline-success btn-block" onclick="openGallery('birInput')">
                                                            <i class="fa fa-sm fa-solid fa-image"></i> Gallery / File
                                                        </button>
                                                    </div>
                                                    <div class="col-4">
                                                        <button type="button" class="btn btn-sm btn-outline-secondary btn-block" onclick="addMorePhotos('birInput')">
                                                            <i class="fa fa-plus"></i> Add More
                                                        </button>
                                                    </div>
                                                </div>

                                                <div id="birPreviewContainer" class="d-flex flex-wrap mt-2 gap-2"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- SEC -->
...
<script>
    ...
    if (institutionalTypeSelect) {
        institutionalTypeSelect.addEventListener('change', function () {
            ...
            const mayorMain = document.getElementById('mayorsInputMain'); 
            const mayorPrc = document.getElementById('mayorsInputPrc');   
            const idSpec = document.getElementById('idInput');            
    ...
    $('#provinceDropdown').select2({ theme: "bootstrap" });
    ...
    // ========= MULTIPLE IMAGE UPLOAD FOR BIR ==========
    let selectedFiles = [];
    const MAX_FILES = 5;

    function setupPreviewBir(inputId, containerId) {
        const input = document.getElementById(inputId);
        ...
        input.addEventListener('change', async function () {
            ...
            updatePreviewBir(containerId, inputId);
            this.value = "";
        });
    }

    function updateInputFilesBir(inputId) {
        const input = document.getElementById(inputId);
    ...
    function updatePreviewBir(containerId, inputId) {
        const container = document.getElementById(containerId);
        container.innerHTML = "";
                ...
                wrapper.innerHTML = `
                    <div style="position:relative;">
                        ...
                        <button type="button" class="btn btn-danger btn-sm position-absolute top-0 end-0"
                            ...
                            onclick="removePhotoBir(${index}, '${containerId}', '${inputId}')">
                            &times;
                        </button>
                    </div>`;
        ...
        updateInputFilesBir(inputId);
    }

    function removePhotoBir(index, containerId, inputId) {
        selectedFiles.splice(index, 1);
        updatePreviewBir(containerId, inputId);
    }

    document.addEventListener("DOMContentLoaded", () => {
        setupPreviewBir('birInput', 'birPreviewContainer');
    });

    // Keep setupPreview for others
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    $("#bldg_name").val(response.business_address);
                } else {
                    $("#station_name").val("");
                    $("#bldg_name").val("");
                    alert("Ship To not found!");
                }
            }
        });
    } else {
        // Clear fields if not exactly 8 digits
        $("#station_name").val("");
        $("#bldg_name").val("");
    }
});
