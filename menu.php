    ...
    <div id="content-wrapper" class="d-flex flex-column min-vh-100" style="background-color: #edfaf4;">
                ...
                <li class="nav-item dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow">
                        ...
                        <a href="changelog.php" class="dropdown-item">
                            <i class="fa-solid fa-circle-info fa-sm fa-fw mr-2 text-gray-400"></i> Changelog
                        </a>
        ...
        <div class="container-fluid">
            ...
            <div class="row g-3">
                ...
                if(in_array(157, $permission) || in_array(158, $permission)){
                    echo '<div class="col-md-2 col-sm-4 col-4">
                        <a class="icon-card btn btn-lg d-flex flex-column text-white" style="background-color:#8540f5;" href="dashboard_stocks.php">
                            <i class="fa fa-boxes"></i>
                            <p>Stocks</p>
                        </a>
                    </div>';
                }else if(in_array(158, $permission)){
                    echo '<div class="col-md-2 col-sm-4 col-4">
                ...
                if(in_array(89, $permission) || in_array(93, $permission) || in_array(97, $permission) || in_array(167, $permission)){
                    echo '<div class="col-md-2 col-sm-4 col-4">
                ...
                if(in_array(171, $permission)){
                    echo '<div class="col-md-2 col-sm-4 col-4">
                        <a class="icon-card btn btn-lg btn-primary d-flex flex-column" href="dashboard_ticket.php">
