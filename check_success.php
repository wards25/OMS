    ...
    <div class="container-fluid">
        <div class="card shadow mb-4 text-center">
            <div class="card-body">
                ...
                <h2><b>Submission Successfully!</b></h2>
                <p>Thank you for submitting your Check.</p>
                <!-- <br> -->
                <p>Your document was sent for approval.
                    <br>
                    A confirmation email has been sent to your submitted email address.
                    Please check your inbox (and spam folder just in case) for further instructions.
                    <br>
                </p>
                <p>
                    <i>You’ll receive an approval email within 1–2 business days.</i>
                </p>
