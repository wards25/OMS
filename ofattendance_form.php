...
if(isset($_SESSION['id']) && $check_submit == 0 && in_array(37, $permission))
{
        ...
        <?php } ?>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="ofattendance_submit.php" enctype="multipart/form-data">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-sm text-center" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    <?php
                                        $result = mysqli_query($conn,"SELECT * FROM tbl_employees WHERE location = '$location' AND shift = '$shift' AND is_active = '1' AND department = 'Logistics-Office' ORDER BY employee_name");
