                ...
                <div class="form-group">
                    <div class="form-row">
                        <div class="col-12 d-flex align-items-center">
                            ...
                            <input type="text" class="form-control form-control-sm" id="view-uom" readonly>
                        </div>
                    </div>
                </div>
                <hr>
                ...
                <div class="form-group">
                    <div class="form-row">
                        <div class="col-12 d-flex align-items-center">
                            ...
                            <select class="form-control form-control-sm search_sku" name="sku" style="width:100%; display:none;" required hidden disabled>
                                <option value=""></option>
                            <?php 
        ...
        $(document).ready(function () {
            ...
            function viewInventory() {
                ...
                $.post("inventory_level_view.php", { rackloc }, function (data) {
                    ...
                    $('#view-qty').val(data.qty);
                    $('#view-uom').val(data.uom);
            ...
            function scanInventory() {
                ...
                $.post("inventory_level_scan_view.php", { groupno, rack, column, level, pos }, function (data) {
                    ...
                    $('.barcode-scan, .sku-id').val('');
                    $('.scan-case, .scan-pcs').val('0');
