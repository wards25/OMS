...
if(isset($_SESSION['id']) && in_array(175, $permission))
{
...
?>
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex align-items-center justify-content-between mb-3">
            <h4 class="mb-0 text-gray-800">Search EWT</h4>
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-wrap justify-content-between align-items-start" style="gap: 10px;">
                            <div class="flex-grow-1 min-w-0 me-md-3">
                                <div class="table-responsive">
                                    ...
                                    $validated_count = 0;
                                    $invoiced_count = 0;
                                    $data_query = mysqli_query($conn,"SELECT status FROM tbl_ewt_raw");
                                    ...
                                    $total_count = $notvalidated_count + $validated_count + $invoiced_count;
                                    ?>
                                    <table class="table table-bordered table-sm mb-0" style="min-width: 100%; max-width: 100%;">
                                        <tbody>
                                            <tr>
                                                <td class="table-warning"><b>Invoiced:</b></td>
                                                <td class="text-center"><b><?php echo $invoiced_count; ?></b></td>
                            ...
                            <div class="flex-shrink-0">
                                <a type="button" class="btn btn-sm btn-light mt-2 mt-md-0" data-toggle="modal"
                                   <?php if(in_array(177, $permission)){ echo 'data-target="#exportModal"'; }else{ echo 'data-target="#alertModal"'; } ?>>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-sm text-center" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    <?php
                                        $result = mysqli_query($conn,"SELECT * FROM tbl_ewt_raw");
                                                ...
                                                <center>
                                                    <a class="d-sm-inline-block btn btn-sm btn-info" name="view" type="button"
                                                       ...
                                                       if (in_array(175, $permission)) { 
                                                           echo 'href="ewt_view.php?link=ewt_search.php&order_no='.$row['order_no'].'&order_date='.$row['order_date'].'"'; 
                                                       } else {  
