...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #21c275;">
            ...
            $menu_items = [
                101 => ['url' => 'trips.php', 'icon' => 'fa-route', 'label' => 'Trip List', 'count' => '0'],
                109 => ['url' => 'picking.php', 'icon' => 'fa-pallet', 'label' => 'For Picking', 'count' => $count_picker],
                106 => ['url' => 'checking.php', 'icon' => 'fa-clipboard-check', 'label' => 'For Checking', 'count' => $count_checker],
                112 => ['url' => 'validation.php', 'icon' => 'fa-user-check', 'label' => 'For Validation', 'count' => $count_validation],
                115 => ['url' => 'sorting.php', 'icon' => 'fa-sort', 'label' => 'For Sorting', 'count' => $count_sorting],
                119 => ['url' => 'invoicing.php', 'icon' => 'fa-file-invoice', 'label' => 'To Invoice', 'count' => $count_invoicing],
                129 => ['url' => 'loading.php', 'icon' => 'fa-people-carry-box', 'label' => 'For Loading', 'count' => $count_loading],
                124 => ['url' => 'dispatch.php', 'icon' => 'fa-truck-fast', 'label' => 'Dispatch', 'count' => $count_dispatch]
            ];
            ...
            foreach ($menu_items as $key => $item) {
                if (in_array($key, $permission)) {
                    ...
                    echo '<span>' . $item['label'] . 
                        ($item['count'] > 0 ? ' <b class="text-warning">[' . $item['count'] . ']</b>' : '') . 
                        '</span>';
                    echo '</a>';
                    echo '</li>';
                }
