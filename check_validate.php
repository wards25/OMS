...
mysqli_query($conn,"UPDATE tbl_check_raw SET status='1',validated_by='$user',validated_date=NOW() WHERE serial_no='$serial_no'");

$action = "VALIDATED: CHECK ".$serial_no;
$module = "FORMS";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['email'])) {
    ...
    if (filter_var($recipient, FILTER_VALIDATE_EMAIL)) {
        ...
        try {
            ...
            $mail->CharSet = 'UTF-8';
            $mail->isHTML(true);
            $mail->setFrom('no-reply@ramoscogroup.com', 'Check Submission - Approved');
            ...
            $mail->Body = '
                <div style="font-family:Helvetica Neue, Helvetica, Arial, sans-serif; padding:20px; background-color:#edfaf4;">
                    <div style="max-width:600px; margin:auto; padding:30px; border-radius:8px; background-color:#ffffff">
                        ...
                        <p style="font-size:13px;">Your Check for the transcation <strong>'.$order_no.'</strong> has been approved!</p>
