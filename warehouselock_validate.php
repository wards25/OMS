        ...
        <?php } ?>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="warehouselock_validate_submit.php" enctype="multipart/form-data">
                        <div class="table-responsive">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        while($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            $validate_query = mysqli_query($conn,"SELECT * FROM tbl_warehouselock_raw WHERE date='$date' AND location='$location' AND shift='$shift' AND shift_type='$shift_type' AND location_name ='$subject'");
