...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #21c275;">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="dashboard_po.php">
            ...
            if(in_array(3, $permission)){
                echo '
                <li class="nav-item">
                    <a class="nav-link" href="po_pending.php">
                    <i class="fa-solid fa-hourglass-end"></i>
                    <span>Pending PO</span></a>
                </li>';
            }else{
            ...
            if(in_array(3, $permission)){
                echo '
                <li class="nav-item">
                    <a class="nav-link" href="po_receiving.php">
                    <i class="fa-solid fa-truck-ramp-box"></i>
                    <span>For Receiving</span></a>
                </li>';
            }else{
