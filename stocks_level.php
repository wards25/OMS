        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header bg-warning">
                    <h6 class="modal-title text-dark" id="exampleModalLabel"><i class="fa-solid fa-barcode"></i>
                        &nbsp;<span id="view-racklocation"></span></h6>
                    ...
                    <div id="product-section">
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                ...
                                <div class="col-4">
                                    <button type="button"
                                        class="btn btn-sm btn-danger btn-block clear-btn">Clear</button>
                                </div>
                            </div>
                        </div>
                        <hr>
                                ...
                                <div class="form-row">
                                    <div class="col-12">
                                        ...
                                        if ($rack_result->num_rows > 0) {
                                            ...
                                            <select class="form-control form-control-sm" name="move_location"
                                                id="search_rack" style="width:100%;" required>
                                                <!-- <option value=""></option> -->
                                                <?php
                                                foreach ($options as $option) {
                                                    ?>
                                                    <option value="<?php echo $option['racklocation']; ?>">
                                                        <?php echo $option['racklocation']; ?> </option>
                                                <?php
                                                }
                                        }
                                        echo '</select>';
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col-12 d-flex align-items-center">
                                    ...
                                    <input type="text" class="form-control form-control-sm sku-itemcode" name="sku"
                                        hidden required>
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        <select class="form-control form-control-sm search_sku" class="search_sku"
                                            name="sku" style="width:100%;" required hidden disabled>
                                            <option value=""></option>
                                            <?php
                                            foreach ($options as $option) {
                                                ?>
                                                <option value="<?php echo $option['itemcode']; ?>">
                                                    <?php echo $option['itemcode'] . ' - ' . $option['description']; ?> </option>
                                            <?php
                                            }
                                    }
                                    ?>
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col-4 d-flex align-items-center">
                                    ...
                                    <select class="form-control form-control-sm received-month" name="received_month"
                                        required>
                                ...
                                <div class="col-4 d-flex align-items-center">
                                    ...
                                    <select class="form-control form-control-sm received-day" name="received_day"
                                        required></select>
                                </div>
                                <div class="col-4 d-flex align-items-center">
                                    <label class="mr-2">Y:</label>
                                    <select class="form-control form-control-sm received-year" name="received_year"
                                        required></select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-row">
                                <div class="col-12 d-flex align-items-center">
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        <select class="form-control form-control-sm received-by" name="received_by"
                                            required>
                                            <?php
                                            foreach ($options as $option) {
                                                ?>
                                                <option value="<?php echo $option['employee_name']; ?>">
                                                    <?php echo $option['employee_name']; ?> </option>
                                            <?php
                                            }
                                    }
                                    ?>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.edit-bbd-btn', editBbdInventory);
    ...
    function editBbdInventory() {
        let id = $(this).data('id');

        $('#scanModal').modal('show');

        $.post("stocks_level_scan_view.php", { id: id }, function (data) {
