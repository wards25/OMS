...
$update_query = mysqli_query($conn,"SELECT * FROM tbl_ewt_raw WHERE order_no = '$order_no' AND order_date = '$order_date'");
            ...
            <div class="card shadow mb-3">
                ...
                <div class="card-body" style="position: relative;">
                        ...
                        <div class="border p-2" style="border: 1px solid #ced4da;">
                            ...
                            <div class="row">
                                <div class="col-12" style="background-color: #0c4562;">
                                    <h6 class="text-center m-1 text-white">EWT INFORMATION</h6>
                                </div>
                            </div>
                            <!-- Website -->
                            ...
                            <div class="row mt-2 align-items-center">
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-12 col-sm-8 col-md-8">
                                            <div class="input-group input-group-sm">
                                                <input class="form-control form-control-sm" type="text" name="order_no" value="<?php echo $fetch_update['order_no']; ?>" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 mb-2">
                                    <div class="row align-items-center">
                                        <div class="col-12 col-sm-4 col-md-4">
                                            <h6 class="mb-0"><small class="text-danger">*</small> Order Date:</h6>
                                        </div>
                                        <div class="col-12 col-sm-8 col-md-8">
                                            <input class="form-control form-control-sm" type="text" name="order_date" autocomplete="off" required value="<?php echo $fetch_update['order_date']; ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mt-0 align-items-center">
                                ...
                                <div class="col-12 col-md-10">
                                    <a type="button" href="#" class="btn btn-info btn-sm btn-block" data-toggle="modal" data-target="#ewt1"><i class="fa fa-paperclip"></i> View Attachment 1</a>
                                    <a type="button" href="#" class="btn btn-info btn-sm btn-block" data-toggle="modal" data-target="#ewt2"><i class="fa fa-paperclip"></i> View Attachment 2</a>
                                    <a type="button" href="#" class="btn btn-info btn-sm btn-block" data-toggle="modal" data-target="#ewt3"><i class="fa fa-paperclip"></i> View Attachment 3</a>
                                    <a type="button" href="#" class="btn btn-info btn-sm btn-block" data-toggle="modal" data-target="#ewt4"><i class="fa fa-paperclip"></i> View Attachment 4</a>
                                    <a type="button" href="#" class="btn btn-info btn-sm btn-block" data-toggle="modal" data-target="#ewt5"><i class="fa fa-paperclip"></i> View Attachment 5</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="text-center mt-2 no-print">
                        ...
                        <?php
                        if($fetch_update['status'] == 0 && in_array(174, $permission)){
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header bg-info">
                                <h6 class="modal-title text-light" id="exampleModalLabel1"><i class="fas fa-image"></i> EWT 1 Attachment</h6>
                            ...
                            <div class="modal-body">
                                <?php
                                $fileBase = 'upload/ewt/'.$fetch_update['website'].'/'.$fetch_update['order_no'].'/' . $fetch_update['order_no'].'_'.$fetch_update['order_date'].'_1';
                ...
                <!-- EWT2 modal -->
                <div class="modal fade" id="ewt2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header bg-info">
                                <h6 class="modal-title text-light" id="exampleModalLabel2"><i class="fas fa-image"></i> EWT 2 Attachment</h6>
                                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true"><small>×</small></span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <?php
                                $fileBase = 'upload/ewt/'.$fetch_update['website'].'/'.$fetch_update['order_no'].'/' . $fetch_update['order_no'].'_'.$fetch_update['order_date'].'_2';
                ...
                <!-- EWT3 modal -->
                <div class="modal fade" id="ewt3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header bg-info">
                                <h6 class="modal-title text-light" id="exampleModalLabel3"><i class="fas fa-image"></i> EWT 3 Attachment</h6>
                                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true"><small>×</small></span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <?php
                                $fileBase = 'upload/ewt/'.$fetch_update['website'].'/'.$fetch_update['order_no'].'/' . $fetch_update['order_no'].'_'.$fetch_update['order_date'].'_3';
                ...
                <!-- EWT4 modal -->
                <div class="modal fade" id="ewt4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel4" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header bg-info">
                                <h6 class="modal-title text-light" id="exampleModalLabel4"><i class="fas fa-image"></i> EWT 4 Attachment</h6>
                                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true"><small>×</small></span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <?php
                                $fileBase = 'upload/ewt/'.$fetch_update['website'].'/'.$fetch_update['order_no'].'/' . $fetch_update['order_no'].'_'.$fetch_update['order_date'].'_4';
                ...
                <!-- EWT5 modal -->
                <div class="modal fade" id="ewt5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel5" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header bg-info">
                                <h6 class="modal-title text-light" id="exampleModalLabel5"><i class="fas fa-image"></i> EWT 5 Attachment</h6>
                                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true"><small>×</small></span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <?php
                                $fileBase = 'upload/ewt/'.$fetch_update['website'].'/'.$fetch_update['order_no'].'/' . $fetch_update['order_no'].'_'.$fetch_update['order_date'].'_5';
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header bg-success">
                            <h6 class="modal-title text-light" id="exampleModalLabel"><i class="fas fa-check"></i> Validate EWT</h6>
                            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true"><small>×</small></span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <h6>Do you want to validate this EWT?</h6>
                        </div>
                        <div class="modal-footer">
                            <button class="btn btn-secondary btn-sm" type="button" data-dismiss="modal">Close</button>
                            <form method="POST" action="ewt_validate.php">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header bg-danger">
                            <h6 class="modal-title text-light" id="exampleModalLabel"><i class="fas fa-times"></i> Reject EWT</h6>
                            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true"><small>×</small></span>
                            </button>
                        </div>
                        <form method="POST" action="ewt_reject.php">
                        <div class="modal-body">
