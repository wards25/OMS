...
$company = isset($_GET['company']) && !empty($_GET['company']) ? $_GET['company'] : ''; //set default value
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-sm table-sm text-center">
                            ...
                            <tbody>
                                ...
                                $result = mysqli_query($conn, "SELECT *, SUM(active) AS active_odoo, SUM(hold) AS hold_odoo 
                                ...
                                while ($row = mysqli_fetch_array($result)) { 
                                    ...
                                    $active_oms = $fetch_active['active_oms'] ?? 0;
                                    ...
                                    $hold_oms = $fetch_hold['hold_oms'] ?? 0;
