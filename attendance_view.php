...
?>
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex align-items-center justify-content-between mb-3">
            <h4 class="mb-0 text-gray-800">WH Attendance Report</h4>
        ...
        <?php } ?>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-sm" width="100%" cellspacing="0">
                                ...
                                $totalpos_query = mysqli_query($conn, "
                                    SELECT *,COUNT(*) as count FROM tbl_attendance_raw 
                                ...
                                <tr>
                                    ...
                                    <?php
                                    $kpi_query = mysqli_query($conn, "SELECT * FROM tbl_kpi WHERE metric = 'WH Attendance Pos'");
                                ...
                                // Average total attendance score based on tbl_attendance_raw only
                                $good_query = mysqli_query($conn, "
                                    SELECT * FROM tbl_attendance_raw 
                                    WHERE date='$date' AND location='$location' 
                                        AND shift='$shift' AND shift_type='$shift_type' 
                                        AND attendance = '1'
                                ");
                                ...
                                <tr>
                                    ...
                                    <?php
                                    $kpi_query = mysqli_query($conn, "SELECT * FROM tbl_kpi WHERE metric = 'WH Attendance'");
                                    $fetch_kpi = mysqli_fetch_array($kpi_query);
                        ...
                        <center><a class="d-sm-inline-block btn btn-info btn-sm" data-toggle="modal" data-target="#ImageModal"><i class="fa fa-sm fa-paperclip"></i> Image</a></center>
                    </div>
                </div>
                <!-- End Table -->
