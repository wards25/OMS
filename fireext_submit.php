...
if(isset($_POST['submit'])){
    ...
    else
    {
        ...
        foreach ($asset_id as $id => $name)
        {
            ...
            mysqli_query($conn,"INSERT INTO tbl_fireext_raw (id,date,location,shift,shift_type,asset_name,asset_id,in_place,cond,remarks,submitted_by,submitted_at,is_validated,validated_by,validated_at) VALUES (NULL,'$date','$location','$shift','$shift_type','Fire Extinguisher','$asset_name','$in_place','$condition','$remarks','$user',NOW(),'1','$user',NOW()) ");
        }

        $action = "SUBMITTED FIRE EXTINGUISHER CHECKLIST";
        $module = "FIRE EXTINGUISHER";
