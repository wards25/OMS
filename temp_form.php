...
if(isset($_SESSION['id']) && $check_submit == 0 && in_array(41, $permission))
{
        ...
        <?php } ?>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-2 bg-primary">
                        <h6 class="m-0 font-weight-bold text-light">Temp Monitoring Form</h6> 
                    </div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="temp_submit.php">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-sm text-center" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    <?php
                                        $result = mysqli_query($conn,"SELECT * FROM tbl_temp_location WHERE location = '$location' AND is_active = '1'");
                                        ...
                                        ?>
                                            ...
                                            <td class="align-middle"><input type="number" class="form-control form-control-sm" name="temperature[<?php echo $row['id']; ?>]" required></td>
                        ...
                        <hr>
                        <center>
                            <button type="button" class="d-sm-inline-block btn btn-sm btn-warning text-dark add-btn" data-toggle="modal" <?php if(in_array(45, $permission)){ echo 'data-target="#addWhseLock"'; }else{ echo 'data-target="#alertModal"'; } ?>><i class="fa fa-plus"></i> Add Location</button>
                            <?php
