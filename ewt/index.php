...
?>
    ...
    <div id="content-wrapper" class="d-flex flex-column min-vh-100" style="background-color: #edfaf4;">
        ...
        <form onsubmit="return saveSignature()" action="../ewt_submit.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="border p-2" style="border: 1px solid #ced4da;">
                            <div class="row">
                                <div class="col-12" style="background-color: #157aae;">
                                    <h5 class="text-center m-2 text-white">EWT SUBMISSION FORM
                                    </h5>
                                </div>
                            </div>
                            <!-- General Information -->
                            ...
                            <div class="row mt-2 align-items-center">
                                ...
                                <div class="col-12 col-md-10">
                                    <select class="form-control form-control-sm" name="website" autocomplete="off" required readonly>
                            ...
                            <div class="row mt-2 align-items-center">
                                ...
                                <div class="col-12 col-md-6 mb-2">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-12 col-sm-8 col-md-8">
                                            <input class="form-control form-control-sm" type="date" name="order_date" autocomplete="off" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header bg-success">
                                <h6 class="modal-title text-light" id="exampleModalLabel"><i class="fa fa-check fa-sm"></i> Submit EWT</h6>
                                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true"><small>×</small></span>
                                </button>
                            </div>
                            <div class="modal-body">
                                Are you sure you want to submit this ewt?
