...
if(isset($_SESSION['id']) && $check_submit == 0 && in_array(73, $permission))
{
        ...
        <?php } ?>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="mousetrap_submit.php">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-sm text-center" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    $result = mysqli_query($conn, "SELECT * FROM tbl_asset_inv WHERE asset_name = 'Mouse Trap' AND location = '$location' AND cond=1");
                                        ...
                                        <td class="align-middle">
                                            <center>
                                                <select class="form-control form-control-sm" name="condition[<?php echo $row['id']; ?>]" 
                                                    ...
                                                    <option value=""></option>
                                                    <option value="With Caught Cockroach">With Caught Cockroach</option>
                                                    <option value="With Caught Mouse">With Caught Mouse</option>
                                                    <option value="With Caught Cockroach And Mouse">With Caught Cockroach And Mouse</option>
                                                    <option value="Missing Mouse Trap">Missing Mouse Trap</option>
                                                </select>
                                            </center>
                                        </td>
                        ...
                        <hr>
                        <center>
                            <button type="button" class="d-sm-inline-block btn btn-sm btn-warning text-dark add-btn" data-toggle="modal" <?php if(in_array(69, $permission)){ echo 'data-target="#addModal"'; }else{ echo 'data-target="#alertModal"'; } ?>><i class="fa fa-plus"></i> Add Asset</button>
            ...
            <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form method="POST" action="mousetrap_add.php" id="AssetForm">
                            <div class="modal-body">
