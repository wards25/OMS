                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-sm">
                                            ...
                                            <tbody>
                                                <?php
                                                $error_types = [
                                                    'Short Picked' => 'table-primary',
                                                    'Over Picked' => 'table-success',
                                                    'Not In Invoice' => 'table-info'
                                                ];

                                                foreach ($error_types as $error_type => $row_class) {
                                                    $sql = "
                                                        SELECT picked_sku, picked_desc, error_type, COUNT(picked_sku) AS sku_count
                                                        FROM tbl_variance_raw
                                                        WHERE error_type = '$error_type' AND form_type = 'PVF' AND status = 1 AND location = '$location'
                                                        GROUP BY picked_sku, picked_desc, error_type
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        echo '<tr class="'.$row_class.'" style="color:#000000;">';
                                                        echo '<td>'.$row['picked_sku'].' - '.$row['picked_desc'].'</td>';
                                                        echo '<td><center>'.$row['sku_count'].'</center></td>';
                                                        echo '<td><center>'.$row['error_type'].'</center></td>';
                                                        echo '</tr>';
                                                    }
                                                }
                                                ?>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-sm">
                                            ...
                                            <tbody>
                                                <?php
                                                $roles = [
                                                    ['field' => 'picker_name', 'label' => 'Picker', 'class' => 'table-primary'],
                                                    ['field' => 'checker_name', 'label' => 'Checker', 'class' => 'table-success'],
                                                    ['field' => 'driver_name', 'label' => 'Driver', 'class' => 'table-info'],
                                                    ['field' => 'helper_name', 'label' => 'Helper', 'class' => 'table-warning']
                                                ];
                                                ...
                                                foreach ($roles as $role) {
                                                    ...
                                                    // Fetch top 3 employees for each role
                                                    $query = mysqli_query($conn, "SELECT $field, COUNT($field) AS employee_count FROM tbl_variance_ref WHERE form_type = 'PVF' AND status = 1 AND location = '$location' GROUP BY $field ORDER BY employee_count DESC LIMIT 3");
                                                    
                                                    // Optional: Add a header for each position
                                                    // echo '<tr><td colspan="3" class="text-center font-weight-bold">'.$label.' - Top 3</td></tr>';

                                                    while ($row = mysqli_fetch_array($query)) {
                                                        echo '<tr class="'.$rowClass.'" style="color:#000000;">';
                                                        echo '<td>'.$row[$field].'</td>';
                                                        echo '<td><center>'.$row['employee_count'].'</center></td>';
                                                        echo '<td><center>'.$label.'</center></td>';
                                                        echo '</tr>';
                                                    }
                                                }
                                                ?>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-sm">
                                            ...
                                            <tbody>
                                                <?php
                                                $error_types = [
                                                    'Shortlanded' => 'table-primary',
                                                    'Overlanded' => 'table-success',
                                                    'Not In Invoice' => 'table-info'
                                                ];
                                                ...
                                                foreach ($error_types as $error_type => $row_class) {
                                                    $sql = "
                                                        SELECT picked_sku, picked_desc, error_type, COUNT(picked_sku) AS sku_count
                                                        FROM tbl_variance_raw
                                                        WHERE error_type = '$error_type' AND form_type = 'LVF' AND status = 1 AND location = '$location'
                                                        GROUP BY picked_sku, picked_desc, error_type
                                                        ORDER BY sku_count DESC
                                                        LIMIT 3
                                                    ";
                                        ...
                                        <table class="table table-bordered table-sm">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($roles as $role) {
                                                    ...
                                                    // Fetch top 3 employees for each role
                                                    $query = mysqli_query($conn, "SELECT $field, COUNT($field) AS employee_count FROM tbl_variance_ref WHERE form_type = 'LVF' AND status = 1 AND location = '$location' GROUP BY $field ORDER BY employee_count DESC LIMIT 3");
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($error_types as $error_type => $row_class) {
                                                    $sql = "
                                                        SELECT picked_sku, picked_desc, error_type, COUNT(picked_sku) AS sku_count
                                                        FROM tbl_variance_raw
                                                        WHERE error_type = '$error_type' AND form_type = 'RVF' AND status = 1 AND location = '$location'
                                                        GROUP BY picked_sku, picked_desc, error_type
                                                        ORDER BY sku_count DESC
                                                        LIMIT 3
                                                    ";
                                        ...
                                        <table class="table table-bordered table-sm">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($roles as $role) {
                                                    ...
                                                    // Fetch top 3 employees for each role
                                                    $query = mysqli_query($conn, "SELECT $field, COUNT($field) AS employee_count FROM tbl_variance_ref WHERE form_type = 'RVF' AND status = 1 AND location = '$location' GROUP BY $field ORDER BY employee_count DESC LIMIT 3");
